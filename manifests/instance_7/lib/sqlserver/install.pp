...
#
# Utility define to copy to a specified JBoss-7.1.1 instance the sqlserver driver jar module.
#
# == Parameters:
#
...
#  }
define jboss::instance_7::lib::sqlserver::install ($instance_name = $title, $environment = 'dev') {
  $require = Class['jboss']
