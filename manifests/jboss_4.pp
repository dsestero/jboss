...
# the desired version.
# Supported versions are: <tt>4.0.0</tt>, <tt>4.0.2</tt>, <tt>4.0.4</tt>, <tt>4.0.5</tt>, <tt>4.2.0</tt>, <tt>4.2.1</tt>,
# <tt>4.2.2</tt>, <tt>4.2.3</tt>.
#
# == Parameters:
#
# $version::   JBoss version. It has to be a three number string denoting a specific version in the JBoss-4 family.
#              Defaults to the resource title.
#
# $jdksuffix:: The string indicating the possible suffix of the filename to specify the jdk used to compile the distribution.
#              Defaults to ''.
#
# == Actions:
#
